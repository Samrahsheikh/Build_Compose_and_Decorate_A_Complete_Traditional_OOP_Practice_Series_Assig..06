...
# Creating instances
student1: Student = Student("Samrah Sheikh", 99)
student2: Student = Student("Mishraz Khan", 95)
...
# Displaying count using class method
...
print(emp._salary)       # accessible (by convention, should not be accessed)
# print(emp.__ssn)       # Not accessible (will raise AttributeError)
print(emp._Employee__ssn)  # Accessing private via name mangling
